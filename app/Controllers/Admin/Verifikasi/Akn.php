...
class Akn extends BaseController
{
    protected $db;
    ...
    {	
        ...
        if (!$this->auth->inGroup($group))
        {
            ...
            return view('admin/verif/akn', $data); //balik ke view
        }
    }
    ...
    public function update($nim)
    {
        ...
        $data_verif=[
            'title' => 'Tambah Data Verifikasi N-AKN',
            'nim' =>$nim,
        ...
        return redirect()->to(base_url('admin/verifikasi/akn')); //balik ke controller
    }
