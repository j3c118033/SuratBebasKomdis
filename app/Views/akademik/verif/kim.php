                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- Print excel -->
                                <div class="col-md">
                                    <a href="<?= base_url('akademik/verifikasi/kim/printexcel'); ?>" class="btn btn-success" style="margin-bottom:20px; margin-left:0">Rekap Data &nbsp;&nbsp;<i class="fas fa-download"></i></a> 
                                </div>
