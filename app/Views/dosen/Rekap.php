            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        <div class="section7">
                            <form action="<?= base_url('dosen/rekap/pencarian/'); ?>" method="POST">
                                <div class="form-row">
                ...
                <div class="card">
                    <div class="card-body wizard-content">
                        <div class="card-body">
                                ...
                                <hr class="garis1">
                                <div class="col-md">
                                    <a href="<?= base_url('dosen/rekap/printexcel'); ?>" class="btn btn-success" style="margin-bottom:20px; margin-left:0">Excel&nbsp;&nbsp;<i class="fas fa-file-excel"></i></a> 
                                </div>
