                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <!-- bagian judul -->
                                <h1 class="judul1">Data Verifikasi Mahasiswa Manajemen Industri Jasa Makanan dan Gizi</h1>
                                <hr class="garis1">
                                ...
                                <!-- print excel -->
                                <div class="col-md">
                                    <a href="<?= base_url('admin/verifikasi/gzi/printexcel'); ?>" class="btn btn-success" style="margin-bottom:20px; margin-left:0">Rekap Data &nbsp;&nbsp;<i class="fas fa-download"></i></a> 
                                </div>
                                            ...
                                            <?php foreach ($verif as $verif) : ?>
                                                <tr>
                                                    ...
                                                    <!-- Proses Verifikasi -->
                                                        ...
                                                        <!-- Modal1 -->
                                                        <!--form input-->
                                                        <form action="<?= base_url('/admin/verifikasi/gzi/update/'.$verif->nim);?>" method="POST">
                                                        <?= csrf_field();?>
