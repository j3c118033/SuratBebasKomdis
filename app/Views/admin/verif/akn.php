                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <!-- Judul bagian -->
                                <h1 class="judul1">Data Verifikasi Mahasiswa Akuntansi</h1>
                                <hr class="garis1">
                                ...
                                <!-- Aksi Print Excel -->
                                <div class="col-md">
                                    <a href="<?= base_url('admin/verifikasi/akn/printexcel'); ?>" class="btn btn-success" style="margin-bottom:20px; margin-left:0">Rekap Data &nbsp;&nbsp;<i class="fas fa-download"></i></a> 
                                </div>
                                            ...
                                            <?php foreach ($verif as $verif) : ?>
                                                <tr>
                                                    ...
                                                    <!-- Proses Verifikasi -->
                                                        ...
                                                        <form action="<?= base_url('/admin/verifikasi/akn/update/'.$verif->nim);?>" method="POST">
                                                        <?= csrf_field();?>
